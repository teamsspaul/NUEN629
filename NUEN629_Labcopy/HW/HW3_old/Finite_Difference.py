...
def inner_iteration(phig,G,I,J,K,Nx,Ny,Nz,hx,hy,hz,ihx2,ihy2,ihz2,BCGs,Sigmarg,Sigmasgg,D,Q,L,lintol=1.0e-8,grouptol=1.0e-6,maxits = 20,LOUD=False):
    iteration = 1
    converged = False
...
def kproblem_mg_diffusion(x,y,I,J,K,G,Nx,Ny,Nz,hx,hy,hz,ihx2,ihy2,ihz2,BCGs,Sigmarg,Sigmasgg,nuSigmafg,chig,D,L,lintol=1.0e-8,grouptol=1.0e-5,tol=1.0e-6,maxits = 3, k = 1, LOUD=True):
    ...
    while not(converged):
        ...
        phi0 = inner_iteration(phi0,G,I,J,K,Nx,Ny,Nz,hx,hy,hz,ihx2,ihy2,ihz2,BCGs,Sigmarg,Sigmasgg,D,Qhat,L)
