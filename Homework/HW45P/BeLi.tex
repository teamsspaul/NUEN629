...
%% B10 Column
  \node[name=B10, Element]
       {\NaturalElementTextFormat
         {$\bm{(n,\alpha)\ss{}{3}{7}Li}$}
         {Stable - 19.9\%}
         {$\bm{\ss{}{5}{10}}$B}
         {2.45 MeV: 0.281 \\14.1 MeV: 0.0445}
         {}
       };
  \node[name=Be9, below of=B10, Element]
       {\NaturalElementTextFormat
         {$\bm{(n,2n)\ss{}{4}{8}Be}$\\
           $\bm{(n,t)\ss{}{3}{7}Li}$\\
           $\bm{(n,\alpha)\ss{}{2}{6}He}$\\
           $\bm{(n,\gamma)\ss{}{4}{10}Be}$\\
           $\bm{(n,p)\ss{}{3}{9}Li}$}
         {Stable - 100\%}
         {$\bm{\ss{}{4}{9}}$Be}
         {2.45 MeV: 0.021, 0, 0.083\\14.1 MeV: 0.48, 0.021, 0.01}
         {}
       };
  \node[name=Li8, below of=Be9, Element]
       {\NaturalElementTextFormat
         {}
         {\\$\bm{\beta^{-1}\rightarrow\ss{}{4}{8}Be}$}
         {$\bm{\ss{}{3}{8}}$Li}
         {}
         {0.8399 s}
       };
%% Be10 Column
  \node[name=Be10, right of=Be9, Element]
       {\NaturalElementTextFormat
         {}
         {\\$\bm{\beta^{-1}\rightarrow\ss{}{5}{10}B}$}
         {$\bm{\ss{}{4}{10}}$Be}
         {}
         {1.4E6 y}
       };
  \node[name=Li9, right of=Li8, Element]
       {\NaturalElementTextFormat
         {}
         {\\$\bm{\beta^{-1}\rightarrow\ss{}{4}{9}Be}$ (49.2)\strut
           \\ $\bm{\beta^{-1}n\rightarrow\ss{}{4}{8}Be}$ (50.8)}
         {$\bm{\ss{}{3}{9}}$Li}
         {}
         {0.178 s}
       };
%% Be8 Column
  \node[name=Be8, left of=Be9, Element]
       {\NaturalElementTextFormat
         {}
         {\\$\bm{\alpha\rightarrow\ss{}{2}{4}He}$}
         {$\bm{\ss{}{4}{8}}$Be}
         {}
         {6E-17 s}
       };
  \node[name=Li7, below of=Be8, Element]
       {\NaturalElementTextFormat
         {$\bm{(n,2n)\ss{}{3}{6}Li}$\\
           $\bm{(n,2n\ \alpha)\ss{}{1}{2}H}$\\
           $\bm{(n,d)\ss{}{2}{6}He}$\\
           $\bm{(n,3n\ \alpha)\ss{}{1}{1}H}$\\
           $\bm{(n,\gamma)\ss{}{3}{8}Li}$}
         {Stable - 92.41\%}
         {$\bm{\ss{}{3}{7}}$Li}
         {2.45 MeV: 0,0,0\\14.1 MeV: 0.03,0.02,0.01}
         {}
       };  
  \node[name=He6, below of=Li7, Element]
       {\NaturalElementTextFormat
         {}
         {\\$\bm{\beta^{-1}\rightarrow\ss{}{3}{6}Li}$}
         {$\bm{\ss{}{2}{6}}$He}
         {}
         {0.8 s}
       };  
%% Li6 Column
  \node[name=Li6, left of=Li7, Element]
       {\NaturalElementTextFormat
         {$\bm{(n,t)\ss{}{2}{4}He}$\\
           $\bm{(n,2n\ \alpha)\ss{}{1}{1}H}$\\
           $\bm{(n,p)\ss{}{3}{6}He}$\\
           $\bm{(n,\gamma)\ss{}{3}{7}Li}$\\}
         {Stable - 7.59\%}
         {$\bm{\ss{}{3}{6}}$Li}
         {2.45 MeV: 0.21,0,0\\14.1 MeV: 0.03,0.08,0.01}
         {}
       };
  \node[name=He5, below of=Li6, Element]
       {\NaturalElementTextFormat
         {}
         {}
         {}
...
%% He4
  \node[name=He4, left of=He5, Element]
       {\NaturalElementTextFormat
         {}
         {\\Stable - 99.9999\%}
         {$\bm{\ss{}{2}{4}}$He}
  ...
  \node[name=H3, below of=He4, Element]
       {\NaturalElementTextFormat
         {\\$\bm{(n,2n)\ss{}{1}{2}H}$}
         {\\$\bm{\beta^{-1}\rightarrow\ss{}{2}{3}He}$}
         {$\bm{\ss{}{1}{3}}$H}
         {2.45 MeV: 0\\14.1 MeV: 0.05}
         {12.32 y}
       };
%% He3
  \node[name=He3, left of=He4, Element]
       {\NaturalElementTextFormat
         {$\bm{(n,p)\ss{}{2}{3}He}$\\
           $\bm{(n,d)\ss{}{1}{2}H}$\\
           $\bm{(n,\gamma)\ss{}{2}{4}He}$}
         {Stable - 0.0001\%}
         {$\bm{\ss{}{2}{3}}$He}
         {2.45 MeV: 0.71,0,9E-5\\14.1 MeV: 0.12,0.08,3E-5}
         {}
       };
  \node[name=H2, below of=He3, Element]
       {\NaturalElementTextFormat
         {$\bm{(n,2n)\ss{}{1}{1}H}$\\
           $\bm{(n,\gamma)\ss{}{1}{3}H}$\\}
         {Stable - 0.0115\%}
         {$\bm{\ss{}{1}{2}}$H}
         {2.45 MeV: 0,8E-6\\14.1 MeV: 0.17,9E-6}
         {}
       };
