...
\begin{homeworkProblem}[Homework 5 Code]
  ...
  of the harder parts of this homework.
...
\begin{homeworkProblem}[Project]
  ...
  Also spontaneous fission isn't represented here, but I included it in the
  code.\\~\\
  ...
  For the current problem 1 metric ton of PWR fuel will be irradiated for a 100 days
  at a constant flux of 10\tss{14} n/cm\tss{2}$\cdot$s and some of the fission product
