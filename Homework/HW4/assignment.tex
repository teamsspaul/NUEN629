...
\begin{homeworkProblem}[Homework 4 Problem Solution]
  ...
  the proper magnitude. This is shown below, in a plot where
  $\Sigma_t=101$ instead of 100.}

  \begin{figure}[H]
    \begin{center}
      \includegraphics[width=1\columnwidth]
                      {Homework4/SourceIteration_101.pdf}
    \end{center}
    \vspace{-8mm}
    \caption{Comparison of solution with $\Sigma_t=101$}
  \end{figure}
  ...
  \textbf{Something else I would like to point out in the solution
    ...
    was solved. will be shown in the case
  ...
  \script{Homework4/Functions.py}
         {\textbf{Diamond Difference Spatial Discretization}}
         {101}{130}{101}
  \script{Homework4/Functions.py}
         {\textbf{Step Discretization}}{132}{161}{132}
  \textbf{Main Program}
  \script{Homework4/Calculations}
         {Main Program}
         {1}{104}{1}
